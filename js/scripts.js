...
$(document).ready(function () {
    ...
    var qtdCards = datasourceCardHTML.length;
    ...
    for (var i = 0; i < qtdCards; i++) {
        ...
        $("#timelineItem").append(
            ...
            '<h2> ' + datasourceCardHTML[i].tituloCard + ' </h2>' +
            '<p>' +
            datasourceCardHTML[i].descricaoCard +
            '</p>' +
            '<a href="' + datasourceCardHTML[i].hrefBotao + '" class="btn btnTimeline">Ver Conteúdo</a>' +
            '</div>' +
            '</div>'
        );
    }
